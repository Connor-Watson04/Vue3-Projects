<template>
  <div class="box-border overflow-hidden text-white p-8 w-full bg-[var(--color-promo)] rounded-xl shadow-[var(--box-shadow)] !mb-5">
    ...
    <div class="bg-[#fff2f2] text-black w-[300px] p-4 rounded-lg shadow-lg shadow-cyan-300 mt-12">
      <p class="mb-4">"Best drink I've ever had, it's cheaper and healthier than others, would definitely recommend."</p>
      <div class="flex items-center gap-2">
        <div class="w-12 h-12 rounded-full bg-gray-300"></div>
        <div>
          <p class="text-sm font-bold">N1ghtW0lf04</p>
          <p class="text-xs font-bold">S-I-S SQUAD Co. Founder</p>
        </div>
      </div>
    </div>
  </div>
