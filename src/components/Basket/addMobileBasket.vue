<template>
    <form class="flex flex-col" @submit.prevent="productData">
      ...
      <div class="mt-2">
        <button class="bg-gradient-to-r from-cyan-400 to-pink-400 border border-black px-4 py-2 cursor-pointer rounded-md hover:bg-green-500 active:translate-y-1 transition">
          Add to basket
        </button>
      </div>
    </form>
